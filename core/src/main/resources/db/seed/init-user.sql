...
insert into Employee ( NAME, PHONE, AGE, GRENDER) values ('Henry', '1234569',24, 1);
insert into Employee ( NAME, PHONE, AGE, GRENDER) values ('Alex', '1234560',30, 0);

insert into CUSTOMER ( NAME, PHONE, AGE, GRENDER) values ('John', '123456',21, 1);
insert into CUSTOMER ( NAME, PHONE, AGE, GRENDER) values ('Terry', '123',22, 0);
insert into CUSTOMER ( NAME, PHONE, AGE, GRENDER) values ('Chris', '1234',24, 1);
insert into CUSTOMER ( NAME, PHONE, AGE, GRENDER) values ('Lee', '12345',30, 0);

insert into EQUIPMENT ( NAME) values ('equip a');
insert into EQUIPMENT ( NAME) values ('equip b');
insert into EQUIPMENT ( NAME) values ('equip c');
insert into EQUIPMENT ( NAME) values ('equip d');

insert into ACCOUNT ( NAME, PRICE, PAID_TIME) values ('income 1', 1000.00, '2012-2-29');
